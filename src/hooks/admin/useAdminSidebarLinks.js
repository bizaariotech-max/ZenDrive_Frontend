    ...
    const links = [
        { id: 1, icon: <LayoutDashboard />, label: "Dashboard", link: "/admin", dock: true },
        {
            ...
            subList: [
                ...
                { id: "2-4", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/manufacturer-master", title: "Manufacturer Master" },
                { id: "2-5", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/vehicle-model-master", title: "Vehicle Model Master" },
                { id: "2-6", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/fuel-type-master", title: "Fuel Type Master" },
                ...
                { id: "2-9", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/color-master", title: "Color Master" },
                ...
                { id: "2-13", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/health-profiling-group", title: "Health Profiling Group" },
                { id: "2-14", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/medical-speciality", title: "Medical Speciality" },
                { id: "2-15", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/question-type", title: "Question Type" },
                { id: "2-16", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/input-type", title: "Input Type" },
                { id: "2-17", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/investigation-type", title: "Investigation Type" },
                { id: "2-18", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/abnormality-master", title: "Abnormality Master" },
                { id: "2-19", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/state-master", title: "State Master" },
                { id: "2-20", icon: <SubdirectoryArrowRightIcon />, path: "/admin/configuration/city-master", title: "City Master" },
            ],
        },
