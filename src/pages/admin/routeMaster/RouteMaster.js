...
const RouteMaster = () => {
    ...
    const [routeList,setRouteList] = useState([]);
        ...
        const columns = [
            ...
            { field: "belongsToStationId", headerName: "Station Type", minWidth: 150, headerClassName: "health-table-header-style", headerAlign: "center", align: "center", renderCell: (params) => <span>{params.row?.StationId?.StationName || "N/A"}</span>, },
            { field: "StartingStationId", headerName: "Starting Station", minWidth: 150, headerClassName: "health-table-header-style", headerAlign: "center", align: "center", renderCell: (params) => <span>{params.row?.StartingStationId?.StationName || "N/A"}</span>, },
            { field: "TerminalStationId", headerName: "Terminal Station", minWidth: 200, headerClassName: "health-table-header-style", headerAlign: "center", align: "center", renderCell: (params) => <span>{params.row?.TerminalStationId?.StationName || "N/A"}</span>, },
            { field: "EnrouteStation", headerName: "En route Station", minWidth: 200, headerClassName: "health-table-header-style", headerAlign: "center", align: "center", renderCell: (params) => <span>{params.row?.EnrouteStation?.map((item) => item?.StationName).join(", ") || "N/A"}</span>, },
            { field: "DistanceInKMs", headerName: "Distance (in kms)", minWidth: 200, headerClassName: "health-table-header-style", headerAlign: "center", align: "center", renderCell: (params) => <span>{params.row?.DistanceInKMs || "N/A"}</span>, },
            { field: "DurationInHrsMins", headerName: "Duration (hh:mm)", minWidth: 150, headerClassName: "health-table-header-style", headerAlign: "center", align: "center", renderCell: (params) => <span>{params.row?.DurationInHrsMins || "N/A"}</span>, },
            {
                field: "actions",
                headerName: "Actions",
                flex: 1,
                ...
                align: "center",
                renderCell: (params) => <DatagridRowAction row={params.row} />,
            }
